...
export const en: Messages = {
  ...
  intake: {
    ...
    fieldColor: 'COLOR',
    fieldStyle: 'STYLE',
    sizesLabel: 'SIZES · PAIRS',
    sizesTotal_one: '{{count}} pair total',
    sizesTotal_other: '{{count}} pairs total',
    sizesEmptyHint: 'Enter quantities',
    ...
    savedToStock_one: 'Added {{count}} pair to stock',
    savedToStock_other: 'Added {{count}} pairs to stock',
    savedDraft_one: 'Saved {{count}} draft',
    savedDraft_other: 'Saved {{count}} drafts',
